...
class Ui_Login(object):
    def setupUi(self, Login):
        ...
        spacerItem14 = QtWidgets.QSpacerItem(20, 101, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
    ...
    def retranslateUi(self, Login):
        ...
        self.label.setText(_translate("Login", "Регистрация бригады"))
        self.label_2.setText(_translate("Login", "Отсканируйте карту участника бригады"))
        ...
        self.label_4.setText(_translate("Login", "Для окончания формирования бригады еще раз отсканируйте карту кладовщика"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_register), _translate("Login", "Регистрация участников"))
        self.label_6.setText(_translate("Login", "Бригада зарегистрирована"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.register_team), _translate("Login", "Регистрация бригады"))
